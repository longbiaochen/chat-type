...
3. Confirm the release assets exist:
   - `dist/ChatType-0.1.1-macos-arm64.zip`
   - `dist/ChatType-0.1.1-macos-arm64.dmg`
...
`v0.1.1` is expected to be locally signed with Apple Development or Developer ID Application and is not notarized.
